...
@aot_dso_cache = dso_local local_unnamed_addr global [981 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.85_name, ; name: libaot-System.Linq.Queryable.dll.so
		ptr null; void* handle
	}, ; 12
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.77_name, ; name: libaot-System.Diagnostics.Tracing.dll.so
		ptr null; void* handle
	}, ; 26
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.89_name, ; name: libaot-System.Net.NetworkInformation.dll.so
		ptr null; void* handle
	}, ; 52
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.108_name, ; name: libaot-System.Transactions.Local.dll.so
		ptr null; void* handle
	}, ; 107
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x1ca3223d11ba4ab9, ; from name: libaot-TestApp2.dll.so
		i64 u0x1ca3223d11ba4ab9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TestApp2.dll.so
		ptr null; void* handle
	}, ; 109
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x240cbbc931aec6d5, ; from name: TestApp2
		i64 u0x1ca3223d11ba4ab9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TestApp2.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.69_name, ; name: libaot-System.ComponentModel.Annotations.dll.so
		ptr null; void* handle
	}, ; 139
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x661dedeffcb7769e, ; from name: aot-TestApp2.dll.so
		i64 u0x1ca3223d11ba4ab9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TestApp2.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa9c91bd5d8dbe3b6, ; from name: TestApp2.dll.so
		i64 u0x1ca3223d11ba4ab9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TestApp2.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd12c85de523be2a6, ; from name: TestApp2.so
		i64 u0x1ca3223d11ba4ab9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TestApp2.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd4008c61a72245a7, ; from name: aot-TestApp2
		i64 u0x1ca3223d11ba4ab9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TestApp2.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xea85c4929b53eeaa, ; from name: aot-TestApp2.so
		i64 u0x1ca3223d11ba4ab9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TestApp2.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf2e5f8a4118043c7, ; from name: libaot-TestApp2
		i64 u0x1ca3223d11ba4ab9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TestApp2.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xff465ae6d83f88c8, ; from name: libaot-TestApp2.so
		i64 u0x1ca3223d11ba4ab9, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TestApp2.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.testapp2\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [23 x i8] c"libaot-TestApp2.dll.so\00", align 16
...
@.DSOCacheEntry.69_name = private unnamed_addr constant [48 x i8] c"libaot-System.ComponentModel.Annotations.dll.so\00", align 16
...
@.DSOCacheEntry.77_name = private unnamed_addr constant [41 x i8] c"libaot-System.Diagnostics.Tracing.dll.so\00", align 16
...
@.DSOCacheEntry.85_name = private unnamed_addr constant [36 x i8] c"libaot-System.Linq.Queryable.dll.so\00", align 16
...
@.DSOCacheEntry.89_name = private unnamed_addr constant [44 x i8] c"libaot-System.Net.NetworkInformation.dll.so\00", align 16
...
@.DSOCacheEntry.108_name = private unnamed_addr constant [40 x i8] c"libaot-System.Transactions.Local.dll.so\00", align 16
